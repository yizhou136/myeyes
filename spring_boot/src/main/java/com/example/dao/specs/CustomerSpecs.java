                ...
                for (Attribute<T, ?> attr : entity.getDeclaredAttributes()){
                    ...
                    if (attrValue != null){
                        if (attr.getJavaType() == String.class){
                            ...
                            predicateList.add(cb.equal(root.get(attribute(entity, attr.getName(), attrValue.getClass())), attrValue));
                        }
                    }
                }
                return predicateList.isEmpty() ? cb.conjunction(): cb.and((Predicate[]) predicateList.toArray());
            }
